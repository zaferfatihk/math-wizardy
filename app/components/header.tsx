      ...
      <div className="container mx-auto px-4 py-2 flex items-center justify-between">
        ...
        <nav>
          <ul className="flex space-x-4">
            <li><Link href="/puzzles" className="text-white-700 font-bold hover:text-blue-800">{translate('nav.puzzles')}</Link></li>
            <li><Link href="/membership" className="text-white-700 font-bold hover:text-blue-800">{translate('nav.membership')}</Link></li>
            <li><Link href="/login" className="text-white-700 font-bold hover:text-blue-800">{translate('nav.login')}</Link></li>
          </ul>
        </nav>
      </div>
    </header>
